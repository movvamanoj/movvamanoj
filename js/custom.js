    ...
    var pages = {
        ...
        dropdown:function(){
            ...
            this.navLi.each(function(){
				if($(this).find('span.top').text() == 'Blog'){
					selectnav.append('<option id="blog-nav" value="Blog">'+$(this).find('span.top').text()+'</option>');
				}else{
    ...
    function showContact() {
        ...
        if (!contactSection.hasClass('activated')){
          ...
          overlay:{
            ...
            address: "Sri Surya Residency, Rajya Lakshmi St, Kannayya Kapu Nagar, Kakinada, Andhra Pradesh 533003",
            options:{
